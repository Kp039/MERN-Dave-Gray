...
const gettAllNotes = expressAsyncHandler(async (req, res) => {
...
const createNewNote = expressAsyncHandler(async (req, res) => {
  ...
  if (note) {
    ...
    return res.status(409).json({ message: "Invalid note data received" });
  }
});
...
export default { gettAllNotes, createNewNote, updateNote, deleteNote };
